...
const PlanCard = ({ data }: IDataProps) => {
  return (
    <Link href={`/workout/${data.id}`}>
      <div className="bg-[#12141a] rounded-2xl overflow-hidden border border-zinc-800/80 hover:border-zinc-700/80 transition-all duration-300 flex flex-col justify-between h-full cursor-pointer group">
        <div>
          {/* Top Image Container */}
          ...
          <div className="p-5">
            ...
            {/* Title */}
            <h3 className="text-lg font-black text-white uppercase tracking-wide leading-snug group-hover:text-[#8bf500] transition-colors">
              {data.name}
            </h3>
